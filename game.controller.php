...
class GameController {
    ...
    public function checkRandom(){
        ...
        if($active_games[0]['gameCount'] > 2){
            $result["status"] = "Too many open games";
        }
    ...
    public function viewGame(){
        ...
        if(isset($_SESSION['joined_game'])){
            ...
            $result["GAMEINFODEBUG"] = $game_info_array;
            $result["SETGAMEID"] = $_SESSION['joined_game'];
            ...
            /*trying to add code to make scroll container work*/
            $this->tempmodel = new GameModel();
            $this->page->vars['games'] = $this->tempmodel->getFullGame(true);

            $active_games = $this->tempmodel->activeGames($_SESSION['pl_id']);
            $this->page->vars['active_games'] = $active_games[0]['gameCount'];

            /*echo json_encode($this->page->renderAjax("gamemenu.view.php"));*/
		/*end test code*/
		
            $result["html"] = $this->page->renderAjax("game.view.php");//, "gamemenu.view.php");
        } else {
    ...
    public function newgame(){
        ...
        echo json_encode($this->page->renderAjax("newgame.view.php"));
    }
    ...
    public function lobby(){
        ...
        echo json_encode($this->page->renderAjax("lobby.view.php"));
    }
